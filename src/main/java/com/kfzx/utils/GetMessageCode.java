...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID="3e1344b7289b43d38d2583417d1ffb41";
    private static final String AUTH_TOKEN="caf2f6494a1b4690a88f25638be07457";


    //根据相应的手机号发送验证码
    public static String getCode(String telephone) throws JSONException{
        String rod=smsCode();
        String timestamp=getTimestamp();
        String sig=getMD5(ACCOUNT_SID,AUTH_TOKEN,timestamp);
        int time = 5;
        String tamp="【双体系开发中心】您的验证码为"+rod+"，请于"+time+"分钟内正确输入，如非本人操作，请忽略此短信。";//这里一定要与新建模板中的短信内容一致，一个空格都不能多，否者短信打死都发不过去哦
